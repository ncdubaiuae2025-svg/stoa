...
pause 0.8
echo ""
echo -e "  ${GREEN}▸${RESET} ${BOLD}JUP${RESET}  \$0.234 (+20.0%)  vol 18M (${YELLOW}3x avg${RESET})"
echo -e "  ${DIM}▸${RESET} SOL  \$84.83 (-2.2%)    vol normal"
echo -e "  ${DIM}▸${RESET} PYTH \$0.043 (-3.9%)    vol normal"
echo -e "  ${DIM}▸${RESET} JTO  \$0.425 (-5.2%)    vol normal"
echo ""
pause 1
echo -e "  ${YELLOW}⚡ SIGNAL: volume_spike on JUP — 3x avg volume, +20% breakout${RESET}"
...
pause 0.8
echo ""
echo -e "  ${DIM}Jupiter quote: 427.35 JUP @ \$0.234 (slippage: 25 bps)${RESET}"
...
pause 0.8
echo ""
echo -e "  ${GREEN}${BOLD}✓ FILLED${RESET} buy 427.35 JUP @ \$0.234 — tx:5xG7...kJmN"
...
echo -e "    JUP: entry \$0.234 → current \$0.242  ${GREEN}+3.4%${RESET}"
echo -e "    stop-loss: -8%  ${GREEN}OK${RESET}"
echo -e "    take-profit: +25%  ${DIM}not yet${RESET}"
echo ""
echo -e "  ${DIM}portfolio: \$1,003.32 | drawdown: 0% | status: ${GREEN}active${RESET}"
echo ""
pause 2
...
echo ""
echo -e "  ${DIM}checking 1 open position...${RESET}"
echo -e "    JUP: entry \$0.234 → current \$0.178  ${RED}${BOLD}-23.9%${RESET}"
echo -e "    stop-loss: -8%  ${RED}${BOLD}✗ BREACHED${RESET}"
echo ""
pause 1
echo -e "  ${DIM}portfolio: \$976.04 | drawdown: ${RED}-18.5%${RESET} | threshold: -15%"
echo ""
pause 1
